...
<head>
    ...
    <title>CliniFlow - Cadastrar Novo Paciente</title>
    ...
    <style>
        ...
        .header-paciente { display: flex; align-items: center; gap: 16px; margin-bottom: 24px; padding-bottom: 16px; border-bottom: 1px solid #E2E8F0; }
        .header-paciente i { font-size: 32px; color: #12A388; background-color: #E6FFFA; padding: 16px; border-radius: 12px; }
        .header-paciente h3 { margin: 0; color: #2D3748; }
            ...
            <div class="admin-form-container">
                ...
                <div class="header-paciente">
                    ...
                    <div>
                        ...
                        <p style="color: #718096; font-size: 13px; margin: 4px 0 0 0;">Crie o cadastro para um novo paciente no sistema.</p>
                    </div>
                </div>

                <form action="admin-cadastro-paciente" method="POST">
                    ...
                    <button type="submit" class="btn-salvar-admin">Cadastrar Paciente no Sistema</button>
                </form>
